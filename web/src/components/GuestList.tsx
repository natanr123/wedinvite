...
export default function GuestList({
  ...
  // Per-guest "details" toggle: the row shows only the name by default;
  // aliases, contact and relations live behind the compact expander.
              ...
              <div className="flex min-w-0 items-center gap-2">
                ...
                {hasExtra && (
                  <button
                    ...
                    className="inline-flex shrink-0 items-center gap-0.5 rounded-md text-xs text-stone-500 hover:text-rose-700"
                  >
                    {t('guest.details')}
                    <ChevronDownIcon
